...
namespace Xbox360MemoryCarver.Utils;
...
public static class BinaryUtils
{
    ...
    /// Uses SIMD-optimized IndexOf for the first byte, then validates the rest.
    /// </summary>
    ...
    {
        // Process 8 bytes at a time using ulong for better performance
